...
const AryOfCart = (item) => {
  ...
  if (ValueTempt?.length) {
    ...
    //console.log(item[3]);
    // item[3] += 1;
    // let index = temptArray.indexOf(Element);
    // console.log(index);
  } else {
...
//   cartproductarray.pus(array)
// localStorage.setItem(arrayOfproducts ,cartproductarray)}
